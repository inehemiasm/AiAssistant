...
- To access Android/localized resources in Jetpack Compose, prefer using the Compose API `val resources = LocalResources.current` instead of fetching them via `LocalContext.current.resources`.
