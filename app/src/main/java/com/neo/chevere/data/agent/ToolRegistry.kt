...
class ToolRegistry @Inject constructor(
    ...
    private fun buildToolsSystemPrompt(): String {
        ...
        return buildString {
            ...
            append("CRITICAL: Never tell the user you cannot check sensor data (sound, light, temperature, noise, brightness, battery). You HAVE real-time sensor access via read_sensors. Always call read_sensors instead of refusing.\n")
